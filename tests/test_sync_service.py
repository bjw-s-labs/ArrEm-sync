...
from arrem_sync.sync_service import TagSyncService
...
class TestTagSyncService:
    ...
    def test_sync_tags_for_item_success(self):
        ...
        emby_item = {
            ...
            "Name": "Test Movie",
            "TagItems": [
                {"Name": "Comedy", "Id": 29189},
            ],  # Different from Arr tags
        }
    ...
    def test_sync_tags_for_item_no_tags(self):
        ...
        emby_item = {"Id": "emby123", "Name": "Test Movie", "TagItems": []}
        self.mock_emby_client.find_item_by_provider_id.return_value = emby_item
    ...
    def test_sync_tags_for_item_missing_tag_items(self):
        """Test sync when Emby item has no TagItems key."""
        mock_tags = [{"id": 1, "label": "Action"}]
        self.mock_arr_client.get_tags.return_value = mock_tags

        arr_item = {"title": "Test Movie", "tmdbId": 12345, "tags": [1]}

        # Emby item without TagItems key (should be treated as empty list)
        emby_item = {
            "Id": "emby123",
            "Name": "Test Movie",
        }
    ...
    def test_find_matching_emby_item_with_debug_logging(self):
        ...
        with patch("arrem_sync.sync_service.logger") as mock_logger:
            result = self.sync_service.find_matching_emby_item(arr_item)
