...
class TestEmbyClient:
    ...
    def test_init(self):
        ...
        client = EmbyClient(server_url="http://localhost:8096", api_key="test_key", user_id="user123")
    ...
    def test_get_all_movies(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "http://localhost:8096/emby/Users/user123/Items",
            params={
    ...
    def test_get_all_series(self, mock_get):
        ...
        client = EmbyClient(server_url="http://localhost:8096", api_key="test_key", user_id="user456")
        ...
        assert result[1]["Id"] == "2"
        mock_get.assert_called_once_with(
            "http://localhost:8096/emby/Users/user456/Items",
            params={
    ...
    @patch("requests.Session.post")
    def test_update_item_tags_with_user_id(self, mock_post):
        """Test updating item tags with user_id."""
        # Mock the POST response for updating
        mock_post_response = Mock()
        mock_post.return_value = mock_post_response
