...
from arr_tagsync.errors import (
...
class TestErrorFormatting:
    ...
    def test_format_missing_env_vars(self):
        ...
        assert "TAGSYNC_ARR_TYPE" in formatted
        assert "TAGSYNC_ARR_URL" in formatted
        assert "TAGSYNC_EMBY_URL" in formatted
        ...
        assert "export TAGSYNC_ARR_TYPE=radarr" in formatted
...
class TestEdgeCases:
    ...
    def test_format_missing_env_vars_edge_case(self):
        ...
        # Should contain export commands (with the TAGSYNC_ prefix that gets added)
        assert "export TAGSYNC_ARR_API_KEY=" in formatted
        assert "export TAGSYNC_EMBY_URL=" in formatted
        assert "export TAGSYNC_LOG_LEVEL=" in formatted
